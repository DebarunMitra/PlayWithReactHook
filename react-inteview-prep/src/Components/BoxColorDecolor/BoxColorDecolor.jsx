        ...
        <div style={{
            ...
            }}>
            {
                boxContainerPattern.map((box, index) => {
                    if(box){
                        return (
                            <Box key={'box-'+index} id={'box-'+index} bgColor='white' handleClick={handleClick} />
                        )
                    }else{
                        return (
                            <Box key={'box-'+index} id={'box-'+index} bg={false} border={false} />
                        )
                    }
                })
            }
...
export default BoxColorDecolor